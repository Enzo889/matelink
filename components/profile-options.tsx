...
import {
  ...
  PopoverContent,
  PopoverTrigger,
} from "@/components/ui/popover"; // Using standard Popover for client components
import {
  LogOut,
  UserCircle,
  Settings,
...
function ProfileOptions() {
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent
        className="w-64 p-2 shadow-xl rounded-lg bg-background border"
        align="end"
      >
        <div className="space-y-1">
          <div className="flex items-center gap-3 p-2 mb-1">
            ...
            <div className="flex-1 overflow-hidden">
              <p className="text-sm font-semibold truncate dark:text-gray-50">
          ...
          <button
            ...
            className="w-full flex cursor-pointer items-center gap-2.5 px-3 py-2 text-sm hover:bg-muted rounded-md transition-colors dark:hover:bg-gray-700/60"
          >
          ...
          <button
            ...
            className="w-full cursor-pointer flex items-center gap-2.5 px-3 py-2 text-sm hover:bg-muted rounded-md transition-colors dark:hover:bg-gray-700/60"
          >
          ...
          <button
            ...
            className="w-full flex items-center cursor-pointer gap-2.5 px-3 py-2 text-sm hover:bg-muted rounded-md transition-colors dark:hover:bg-gray-700/60"
          >
          ...
          <button
            ...
            className="w-full flex items-center cursor-pointer gap-2.5 px-3 py-2 text-sm text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-md transition-colors dark:text-red-400"
          >
            <LogOut size={16} />
            Sign out
          </button>
          <button
            ...
            className="w-full flex items-center cursor-pointer gap-2 px-2 py-1.5 text-sm hover:bg-muted rounded-md transition-colors"
          >
            <UserPlus size={16} />
            Change account
          </button>
