  ...
  public: {
    Tables: {
      ...
      interests: {
        ...
        Relationships: [
          {
            foreignKeyName: "interests_user_uuid_fkey"
            columns: ["user_uuid"]
            isOneToOne: false
            referencedRelation: "users"
      ...
      notifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "notifications_noti_uuid_fkey"
            columns: ["noti_uuid"]
            isOneToOne: true
            referencedRelation: "users"
            referencedColumns: ["uuid"]
          ...
          {
            foreignKeyName: "notifications_petition_id_fkey"
            columns: ["petition_id"]
            isOneToOne: false
      ...
      petition_tags: {
        ...
        Relationships: [
          {
            foreignKeyName: "petition_tags_petition_id_fkey"
            columns: ["petition_id"]
            isOneToOne: false
            referencedRelation: "petitions"
            referencedColumns: ["id"]
      ...
      user_interests: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "user_interests_user_uuid_fkey"
            columns: ["user_uuid"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["uuid"]
